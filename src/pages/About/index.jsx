  ...
  return (
    <div className='w-full mt-32'>
      <div className='flex flex-col px-5 lg:px-[70px]'>
        ...
        <div className='relative lg:mt-[79px] mb-[79px] flex flex-col xl:flex-row gap-[200px] px-5 xl:px-[120px]'>

        <div className='flex hidden flex-col items-center justify-center relative animate__animated animate__fadeInRightBig animate__delay-2s xl:hidden'>
          ...
          <div className='flex flex-col mt-14 xl:mt-0 lg:w-[505px] my-auto gap-[36px]'> {/* mt-64  */}
      ...
      <div className='px-5 lg:px-[70px] flex flex-col mt-[42px] lg:mt-[200px]'>
        ...
        <p className='font-inter font-medium text-lg lg:w-[1025px]'> {/* lg:leading-[36px] */}
