...
const GreenHydrogen = () => {
  ...
  return (
    <div className='mt-32'>
        ...
        <div className='bg-[#F6FFF2] px-5 lg:px-[62px] py-[88px] w-full flex flex-col'>
            <div className='flex flex-col gap-5'>
                <p className='font-inter font-semibold text-3xl lg:text-[49px]'>Green Hydrogen</p>
            ...
            <div className='flex flex-col gap-2 mt-[57px]'>
                <p className='font-inter font-medium text-2xl lg:text-[39px]'>Renewable Energy Integration</p>
            ...
            <div className='flex flex-col gap-2 mt-[29px]'>
                <p className='font-inter font-medium text-2xl lg:text-[39px]'>Storage and transportation</p>
                <p className='text-[20px] font-inter'>
            ...
            <div className='flex flex-col gap-2 mt-[44px]'>
                <p className='font-inter font-medium text-2xl lg:text-[39px]'>Infrastructure and policy</p>
            ...
            <div className='flex flex-col gap-2 mt-[44px]'>
                <p className='font-inter font-medium text-2xl lg:text-[39px]'>Environmental Impact</p>
            ...
            <div className='flex flex-col gap-2 mt-[44px]'>
                <p className='font-inter font-medium text-2xl lg:text-[39px]'>International Collaboration</p>
