  ...
  return (
    <div className='mt-32'>
        ...
        <div className='bg-[#F6FFF2] px-5 lg:px-[77px] py-[93px] w-full flex flex-col'>
            <div className='flex flex-col gap-10 lg:gap-[98px]'>
                <p className='font-inter font-semibold text-3xl lg:text-[49px]'>Bio maritime decarbonisation  </p>
                <div className='flex flex-col gap-3 lg:w-[1137px]'>
