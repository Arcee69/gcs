    ...
    <div className='mt-20'>
        ...
        <div className='bg-[#F6FFF2] px-[77px] py-[93px] w-full flex flex-col'>
            <div className='flex flex-col gap-5'>
                <p className='font-inter font-semibold text-[49px]'>Transport Circular Economy</p>
                ...
                <div className='flex flex-col gap-2 mt-[33px]'>
                    <p className='font-inter font-semibold text-[30px]'>Visit Circular Economy and Social Value in Transport (CESViT) to learn more</p>
